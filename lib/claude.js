...
// Generates 7 follow-up emails (days 2, 5, 9, 14, 20, 27, 35) for a quote.
...
Quote sent on: ${quote.quote_date}${expires ? `\nQuote pricing holds until: ${expires} (real deadline — use it as genuine urgency in email 5)` : ""}

Write exactly 7 follow-up emails. Keep them distinct — no repeating the same line:
...
- Email 3 (day 9): add value — share one practical tip about the materials or the job.
- Email 4 (day 14): mention scheduling or material availability as a natural reason not to wait too long.
- Email 5 (day 20): ${expires ? `reference the pricing holding until ${expires} as a real, honest reason to decide soon.` : `a short "still interested?" nudge — no pressure, just checking if it's still on their radar.`}
- Email 6 (day 27): a short nudge from a fresh angle — offer to update or re-quote if the scope or timeline has changed on their end.
- Email 7 (day 35): the polite close-out. "Should I keep this quote open or close it out?" - the takeaway angle that gets replies.
...
[{"day":2,"subject":"...","body":"..."},{"day":5,"subject":"...","body":"..."},{"day":9,"subject":"...","body":"..."},{"day":14,"subject":"...","body":"..."},{"day":20,"subject":"...","body":"..."},{"day":27,"subject":"...","body":"..."},{"day":35,"subject":"...","body":"..."}]`;
